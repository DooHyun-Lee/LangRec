...
META_ROOT = '/home/doolee13/LangRec/pretrain/data'
SEQ_ROOT = '/home/doolee13/LangRec/pretrain/data'

pretrain_cats = ['Automotive']

pretrain_meta_pathes = [f'{META_ROOT}/meta_{cat}.json.gz' for cat in pretrain_cats]
